 ...
 * AddEvent.java
 *
 * Created on 27. duben 2009, 15:41
 */
package dialogs;
import java.util.*;
import client.*;
...
public class AddEvent extends javax.swing.JDialog {
     ...
     private void initComponents() {
          ...
          jSpinner6.setMaximumSize(new java.awt.Dimension(0, 23));
          ...
          jSpinner9.setPreferredSize(new java.awt.Dimension(80, 26));
          jSpinner9.setValue(2009);
     ...
     private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
	  ...
	  try {
        ...
        {
		    JOptionPane.showMessageDialog(new javax.swing.JFrame(), "Event name contains whitespaces", "Error", JOptionPane.ERROR_MESSAGE);
		    return;
        }
